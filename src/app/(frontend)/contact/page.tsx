            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    <LuYoutube className="w-5 h-5 text-foreground/60 group-hover:text-primary transition-colors" />
                  ...
                  <Link
                    ...
                    className="flex items-center gap-3 p-3 rounded-lg bg-card border border-border hover:border-primary/50 transition-colors group"
                  >
                    <LuTwitter className="w-5 h-5 text-foreground/60 group-hover:text-primary transition-colors" />
                    <span className="text-foreground/70 group-hover:text-foreground text-sm">
                      Twitter/X
                    </span>
                  </Link>
                  <Link
                    ...
                    className="flex items-center gap-3 p-3 rounded-lg bg-card border border-border hover:border-primary/50 transition-colors group"
                  >
                    <LuLinkedin className="w-5 h-5 text-foreground/60 group-hover:text-primary transition-colors" />
                    <span className="text-foreground/70 group-hover:text-foreground text-sm">
                      LinkedIn
                    </span>
                  </Link>
                  <Link
                    ...
                    className="flex items-center gap-3 p-3 rounded-lg bg-card border border-border hover:border-primary/50 transition-colors group"
                  >
                    <LuGithub className="w-5 h-5 text-foreground/60 group-hover:text-primary transition-colors" />
                    <span className="text-foreground/70 group-hover:text-foreground text-sm">
                      GitHub
                    </span>
                  </Link>
